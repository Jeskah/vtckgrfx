...
const typography = [
    ...
    { svg: VatickGraff, alt: "vatick", description:"Vatick variation a little more graffiti-esque while also maintaining a loose and clean feel ", scale: 1.4},
...
export default function Typography() {
    ...
    return (
        <div className="flex flex-col items-center w-full gap-2">
            ...
            <div className="h-80 flex items-center justify-center border-2 border-[#78445C] w-92 text-[#78445C]!">
                
                <CurrentSvg
                    width={170}
                    height={170}
                    className="[&_path]:fill-current object-contain max-h-full max-w-full"
            ...
            <div className="flex flex-row justify-between gap-71 bottom-12 relative [&_path:fill-current] text-[#97a590] ">
                ...
                <button onClick={prev} className="flex justify-center items-center border-t-2 border-r-2 border-[#78445C] h-10 w-10 rounded-tr-[5px]">
            ...
            <div className="border-2 border-[#78445C] rounded-b-[7px] h-25 w-92 flex relative -mt-9">
                ...
                <h1 className={`${fugazOne.className} text-[8px]! uppercase w-90 p-3 leading-4 text-[#78445C]! opacity-30`}>
            {current.description}
                </h1>
